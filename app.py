#!/usr/bin/env python3
"""UseAI - Flask Web Interface (curl_cffi edition)"""
...
# ===== Tüm HTTP istekleri curl_cffi ile =====
        ...
        for p in sys.path:
            ...
            if os.path.isdir(pkg_dir) and os.path.isfile(init_file):
                spec = importlib.util.spec_from_file_location(
                    "websocket", init_file, submodule_search_locations=[pkg_dir]
                )
...
def new_session() -> CffiSession:
    """curl_cffi Session — Chrome 120 TLS/JA3 fingerprint."""
...
def api_upload():
    ...
    # curl_cffi multipart: 'files' parametresi tuple listesi olarak da kabul edilir
    files = [
        ("name", (None, filename)),
        ("type", (None, mime)),
